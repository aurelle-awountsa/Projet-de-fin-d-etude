(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~admin-admin-module~features-features-module"], {
    /***/
    "HrOH":
    /*!**************************************************!*\
    ...
    /***/
    function HrOH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var BookingService = /*#__PURE__*/function () {
        ...
        _createClass(BookingService, [{
          ...
          value: function getAllBookings() {
            ...
            return this._http.get('/server/api/bookings/all', {
              headers: httpAuthHeaders
            });
          }
        }, {
          key: "getTeacherBookings",
          value: function getTeacherBookings() {
            var httpAuthHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set('Authorization', this.token);
            return this._http.get('/server/api/teacher/bookings', {
              headers: httpAuthHeaders
            });
          }
        }, {
          key: "addUserBooking",
          value: function addUserBooking(booking) {
            var httpAuthHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set('Authorization', this.token);
            return this._http.post('/server/api/user/booking', booking, {
              headers: httpAuthHeaders
            });
          }
        }, {
          key: "addTeacherBooking",
          value: function addTeacherBooking(booking) {
            var httpAuthHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set('Authorization', this.token);
            return this._http.post('/server/api/teacher/booking', booking, {
              headers: httpAuthHeaders
            });
          }
        }]);
    ...
    /***/
    function PN1e(module, exports, __webpack_require__) {
      /*!
    ...
    /***/
    function PjKf(module, exports, __webpack_require__) {
      /*!
        ...
        */
        ...
        function (_super) {
          ...
          SimpleTimeGrid.prototype.render = function (props) {
            ...
            this.timeGrid.receiveProps(_assign2({}, this.slicer.sliceProps(props, dateProfile, null, this.timeGrid, dayRanges), {
              dateProfile: dateProfile,
    ...
    /***/
    function ogxq(module, exports, __webpack_require__) {
      /*!
                ...
                if (_this.validMutation) {
                  ...
                  if (receivingCalendar === initialCalendar_1) {
                    ...
                    for (var _i = 0, _a = initialCalendar_1.pluginSystem.hooks.eventDropTransformers; _i < _a.length; _i++) {
                      ...
                      _assign3(eventDropArg, transformer(_this.validMutation, initialCalendar_1));
                    }

                    _assign3(eventDropArg, {
                      el: ev.subjectEl,
...
//# sourceMappingURL=default~admin-admin-module~features-features-module-es5.js.map